...
const username = "zadeviggers";

if (typeof Sa11y !== "object") {
    /* Append sa11y.css */
    const sa11ycss = document.createElement("link");
    sa11ycss.setAttribute("rel", "stylesheet");
    sa11ycss.setAttribute("href", `https://cdn.jsdelivr.net/gh/${username}/sa11y@${version}/dist/css/sa11y.min.css`);
    ...
    combine.src = `https://cdn.jsdelivr.net/combine/gh/${uusername}/sa11y@${version}/dist/js/lang/en.umd.js,gh/${username}/sa11y@${version}/dist/js/sa11y.umd.min.js`;
